              ...
              <>
                ...
                <div className="mt-4 border-t border-white/15 pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <input required autoComplete="email" type="email" className="rounded-lg border border-white/15 bg-white/10 px-3 py-2 text-sm text-white placeholder-white/40 focus:border-brand-orange focus:outline-none" placeholder="Email *" value={cli.email} onChange={e => setCli({ ...cli, email: e.target.value })} />
